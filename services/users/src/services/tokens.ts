...
/**
 * Stateless access-token verifier for the users service (WP-016 identity
 ...
 * gateway's verifier implements (AR-008). The `sub` claim is the caller's
 * identity for all self-scoped `me` endpoints.
 */
