...
/**
 * Stateless access-token verifier for the content service (WP-016 identity
 ...
 * gateway and the users service implement (AR-008). The `sub` claim is the
 * caller's identity for all self-scoped and staff-gated handlers.
 */
