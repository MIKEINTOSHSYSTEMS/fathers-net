...
import { toErrorEnvelope, ERROR_CODES, FathersNetError, type ErrorCode } from '@fathersnet/errors';
 ...
 * 5xx; sanitizes via toErrorEnvelope. 4xx are passed through with their code.
 */
